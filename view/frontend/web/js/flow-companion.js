...
'es6-collections'
    ...
    flow.cmd('on', 'ready', function() {
        ...
        flow.magento2.enabled = flow_enabled;
        flow.magento2.production = flow_production;
        flow.magento2.support_discounts = flow_support_magento_discounts;
        flow.magento2.cart_localize = flow_cart_localize;
        flow.magento2.catalog_localize = flow_catalog_localize;
        flow.magento2.pricing_timeout = flow_pricing_timeout;
        flow.magento2.payment_methods_enabled = flow_payment_methods_enabled;
        flow.magento2.shipping_window_enabled = flow_shipping_window_enabled;
        flow.magento2.tax_duty_enabled = flow_tax_duty_messaging_enabled;
